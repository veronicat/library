...
public class LibraryApp {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < authorArray.length - 1; i++) {
			...
			for (int j = 0; j < 3; j++) {
				Book.addBook(authorArray[i], "BookName" + j, "Description" + j,
						"Date" + j, (10.05 + j));
			}
		}
		...
		Book.addBook(authorArray[4], "A Little Princess", "Princess book",
				"12.02.1990", 24.95);
		...
		Book.addBook(authorKolya, "NewBook1", "NBDescription1", "nbdata1",
				18.05);
		Book.addBook(authorKolya, "NewBook2", "NBDescription2", "nbdata2", 0.05);
		// Add two new books of Kolya

		Book editedBook = authorKolya.editBookDescription("New Year",
				"New description here!!!");
		System.out.println(editedBook.getName() + " description changed to "
				+ editedBook.getDescription());
		System.out.println("Book of " + Book.getAuthorName(editedBook)
				+ " was edited");
